...
#         self.switch = Pin(38, Pin.IN, Pin.PULL_UP)
#         self.swvalue = sw.value(self.switch)
...
#         if (self.swvalue==0 or self.swvalue==0) and not self.dino_jump: #jump
#             self.dino_duck = False
#             self.dino_run = False
#             self.dino_jump = True
...
#             self.dino_run = False
#             self.dino_jump = False
#         elif not (self.dino_jump or userInput[pygame.K_DOWN]): #run
#             self.dino_duck = False
#             self.dino_run = True
#             self.dino_jump = False

        if (userInput[pygame.K_UP] or userInput[pygame.K_SPACE]) and not self.dino_jump: #jump
            self.dino_duck = False
            self.dino_run = False
            self.dino_jump = True
        elif userInput[pygame.K_DOWN] and not self.dino_jump: #duck
    ...
    while run:
        ...
        for obstacle in obstacles:
            ...
            if player.dino_rect.colliderect(obstacle.rect):
                ...
                gameover_over_font = pygame.font.Font("freesansbold.ttf", 72)
                game_over_text = gameover_over_font.render("GAME OVER", True, (0, 0, 0))  # สีแดง
